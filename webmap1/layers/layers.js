...
var lyr_Toilet_2 = new ol.layer.Vector({
    ...
    popuplayerPanpanColor: 'lavender',
    interactive: true,
    title: 'Toilet<br />\
...
var lyr_SportsFacility_3 = new ol.layer.Vector({
    ...
    popuplayerPanpanColor: 'aliceblue',
    interactive: true,
...
var lyr_Seating_4 = new ol.layer.Vector({
    ...
    popuplayerPanpanColor: 'floralwhite',
    interactive: true,
    title: 'Seating<br />\
...
var lyr_PointofInterest_5 = new ol.layer.Vector({
    ...
    popuplayerPanpanColor: 'mintcream',
    interactive: true,
...
var lyr_FoodandDrink_6 = new ol.layer.Vector({
    ...
    popuplayerPanpanColor: 'seashell',
    interactive: true,
...
var lyr_Entrance_7 = new ol.layer.Vector({
    ...
    popuplayerPanpanColor: 'whitesmoke',
    interactive: true,
    title: 'Entrance<br />\
...
lyr_Toilet_2.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
lyr_SportsFacility_3.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
lyr_Seating_4.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
lyr_PointofInterest_5.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
lyr_FoodandDrink_6.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
lyr_Entrance_7.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
lyr_CarParking_8.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
lyr_BikeParking_9.set('fieldLabels', { 'Name': 'inline label - visible with data', 'Photo': 'header label - visible with data', 'TypeCode': 'hidden field', 'Date Surveyed': 'hidden field', 'Access Restricted': 'inline label - visible with data', 'Type': 'hidden field', 'TypeName': 'hidden field', });
