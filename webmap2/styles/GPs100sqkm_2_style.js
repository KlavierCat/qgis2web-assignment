...
var style_GPs100sqkm_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("GP_100KM2");
    var labelText = "";
    size = 0;
    ...
    if (value >= 2.500000 && value <= 5.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.600000 && value <= 8.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.800000 && value <= 12.500000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.500000 && value <= 25.900000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 25.900000 && value <= 254.200000) {
            style = [ new ol.style.Style({
