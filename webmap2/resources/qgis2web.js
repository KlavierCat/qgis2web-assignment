...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 15, minZoom: 5, projection: new ol.proj.Projection({
            code: 'EPSG:29902',
            //extent: [15477.428486, 19589.928000, 374361.644848, 466919.309000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([1101.263977, 8406.693475, 385586.804947, 478102.543525], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GPs in Ireland</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (152 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'A data visualisation project showing the distribution of general practitioner by county in Ireland.  Data sources: cso.ie,  hse.ie.  Compiled: May 2024.';
            }
