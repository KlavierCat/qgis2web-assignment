...
map.getView().fit([-1409835.953540, 4005770.621958, 4615973.794801, 11327453.434458], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GPs in the EU</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (181 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Data visualisation of the distribution of general practitioners in the EU.  Data sources: Eurostat, EuroGeographics.  Data from 2021,  2020 (Denmark,  Sweeden),  2017 (Luxembourg). ';
            }
