...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 12, minZoom: 5, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
...
map.getView().fit([-1231400.274446, 6654664.754442, -572682.665359, 7496775.334242], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lighthouses in the Island of Ireland</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (103 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'A map of the lighthouses in the island of Ireland,  using data from Open Street Map.  Made in Nov 2024.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_lighthousesintheislandofIreland_1,
    colName: 'name',
    zoom: 10,
    collapsed: true,
    map: map
